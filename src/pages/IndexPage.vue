  ...
  <body>
    ...
    <section id="services">
      <div class="services container">
        <div class="service-top">
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsum deleniti maiores pariatur assumenda quas magni et, doloribus quod voluptate quasi molestiae magnam officiis dolorum, dolor
    ...
    <section id="about">
      <div class="about container">
        ...
        <div class="col-right">
          ...
          <h2>Laundry Camelia</h2>
          <p>Berdiri sejak 2012 yang bertempat di Semanggi kecamatan Pasar kliwon Kota surakarta</p>
    ...
    <section id="footer">
      <div class="footer container">
        ...
        <h2>Layanan Tidak Pernah Menurun</h2>
        ...
        <p>Copyright © 2024 laundry. All rights reserved</p>
      </div>
    </section>
    <!-- End Footer -->
  </body>
